...
interface DeleteContatosFromGrupoUsecaseRequest {
  contatoIds: number | number[];
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  grupoId: any;
}

export class DeleteContatosFromGrupoUsecase {
  constructor(private contactGroupRepository: IContactGroupRepository) {}

  async execute(data: DeleteContatosFromGrupoUsecaseRequest): Promise<void> {
    ...
    return this.contactGroupRepository.deleteContactsFromGroup(
      contatoIds,
      grupoId,
    );
  }
